package de.db12.application.server.handler;
...
import de.db12.application.client.dispatch.greeting.SendGreeting;
import de.db12.application.client.dispatch.greeting.SendGreetingResult;
